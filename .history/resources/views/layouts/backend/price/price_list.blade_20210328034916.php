                ...
                <div class="col-md-12">
                    ...
                    <div id="paymentForm" class="col-md-12" style="display: none;">
                        ...
                        <div class="card stripe">
                            <div class="card-header" style="background: #007bff">
                                <h3 class="card-title" style="color: #fff">Select Payment Gateway <button type="button" onclick="stripeVisible()" class="btn btn-success">Stripe </button> or <button type="button" onclick="paypalVisible()" class="btn btn-dark"> Paypal</button></h3>
                                <button type="button" onclick="closeForm()" class="close" aria-label="Close">
                                    <span style="color: #fff" aria-hidden="true">&times;</span>
                                </button>
                            </div>
                                ...
                                <form role="form" action="{{ route('stripe.post') }}" method="post" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="{{ env('STRIPE_KEY') }}" id="payment-form">
                                    ...
                                    <div class='form-row row'>
                                       <div class='col-xs-12 col-md-6 form-group required'>
                                          ...
                                          <input name="c_name" placeholder="enter card name" class='form-control' size='4' type='text'>
                                       </div>
                                       <div class='col-xs-12 col-md-6 form-group required'>
                                          <label class='control-label'>Card Number</label> 
                                          <input name="c_number" placeholder="card number" autocomplete='off' class='form-control card-number' size='20' type='text'>
                                       </div>                           
                                    </div>                        
                                    <div class='form-row row'>
                                       ...
                                       <div class='col-xs-12 col-md-4 form-group expiration required'>
                                          ...
                                          <input name="month" class='form-control card-expiry-month' placeholder='MM' size='2' type='text'>
                                       </div>
                                       <div class='col-xs-12 col-md-4 form-group expiration required'>
                                    ...
                                    <div class='form-row row'>
                                        <div class='form-group col-md-12'>
                                            ...
                                            <input id="pack" name="package" placeholder="enter card name" class='form-control' readonly>
                                        </div>
                                        <div class='form-group col-md-12'>
                                            <label class='control-label'>Package Duration</label> 
                                            <input id="pack_dur" name="duration" placeholder="enter card name" class='form-control' readonly>
                                        </div>
                                        <div class='form-group col-md-12'>
                                            <label class='control-label'>Package Price</label> 
                                            <input id="pack_price" type="number" name="price" placeholder="enter card name" class='form-control' readonly>
                                        </div>
                                    </div>
                                    <div class="form-row row">
                                       <div class="col-xs-12">
                            ...
                            <div class="card-body" id="paypalForm" style="display: none;">
                                <form class="form-horizontal" method="POST" role="form" action="{{route('paypal.post')}}" >
                                    ...
                                    <div class='form-group col-md-12'>
                                        <label class='control-label'>Package Name</label> 
                                        <input id="p_pack" name="package" placeholder="enter card name" class='form-control' readonly>
                                    </div>
                                    <div class='form-group col-md-12'>
                                        <label class='control-label'>Package Duration</label> 
                                        <input id="p_pack_dur" name="duration" placeholder="enter duration" class='form-control' readonly>
                                    </div>
                                    <div class='form-group col-md-12'>
                                        <label class='control-label'>Package Price</label> 
