...
<div class="messenger">
    ...
    <div class="messenger-listView">
        ...
        <div class="m-header">
            <div style="background: #4c4752; height:2.7rem; padding:10px">
                @if(auth()->user()->type == 'super_admin')
                <a href="{{ route('dashboard') }}" style="float: left"><i class="fas fa-tachometer-alt"></i> Dashboard </a>
                <a href="{{ route('home') }}" style="float: right"><i class="fas fa-home"></i> Home</a>
                @else
                <a href="{{ route('home') }}" style="float: left"><i class="fas fa-home"></i> Home</a>
                @endif
        ...
        {{-- tabs and lists --}}
        <div class="m-body" style="margin-top:180px !important">
           {{-- Lists [Users/Group] --}}
           {{-- ---------------- [ User Tab ] ---------------- --}}
