    ...
    <div class="register-box col-md-8">
        ...
        <div class="card">
            ...
            <div id="payment" style="display: none;">
                <p style="font-size: 30px;padding:20px !important;" class="login-box-msg">You have to pay first.Select payment gateway 
                    ...
                    <form role="form" action="{{ route('stripe.post') }}" method="post" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="{{ env('STRIPE_KEY') }}" id="payment-form">
                        ...
                        <div class='form-row row'>
                            <div class='col-xs-12 col-md-6 form-group required'>
                                ...
                                <input onkeyup="getVal(this.value)" name="username" placeholder="enter username" class='form-control' type='text' required>
                            </div>
                           <div class='col-xs-12 col-md-6 form-group required'>
                              <label class='control-label'>Name Card</label> 
                              <input name="c_name" placeholder="enter card name" class='form-control' size='4' type='text' required>
                           </div>
                           <div class='col-xs-12 col-md-6 form-group required'>
                              <label class='control-label'>Card Number</label> 
                              <input name="c_number" placeholder="card number" autocomplete='off' class='form-control card-number' size='20' type='text' required>
                           </div>
                           <div class='col-xs-12 col-md-6 form-group required'>
                            <label class='control-label'>CVC</label> 
                            <input name="cvc" autocomplete='off' class='form-control card-cvc' placeholder='ex. 311' size='4' type='text' required>
                         </div>                           
                        </div>                        
                        <div class='form-row row'>
                        ...
                        <div class='form-row row'>
                            <div class='form-group col-md-12'>
                                ...
                                <input id="pack" name="package" placeholder="enter card name" class='form-control' readonly required>
                            </div>
                            <div class='form-group col-md-12'>
                                <label class='control-label'>Package Duration</label> 
                                <input id="pack_dur" name="duration" placeholder="enter card name" class='form-control' readonly required>
                            </div>
                            <div class='form-group col-md-12'>
                                <label class='control-label'>Package Price</label> 
                                <input id="pack_price" type="number" name="price" placeholder="enter card name" class='form-control' readonly required>
                            </div>
                        </div>
                ...
                <div class="card-body" id="paypalForm" style="display: none;">
                    <form class="form-horizontal" method="POST" role="form" action="{{route('paypal.post')}}" >
                        ...
                        <div class='form-group col-md-12'>
                            <label class='control-label'>Package Name</label> 
                            <input id="p_pack" name="package" placeholder="enter card name" class='form-control' readonly required>
                        </div>
                        <div class='form-group col-md-12'>
                            <label class='control-label'>Package Duration</label> 
                            <input id="p_pack_dur" name="duration" placeholder="enter duration" class='form-control' readonly required>
                        </div>
                        <div class='form-group col-md-12'>
                            <label class='control-label'>Package Price</label> 
