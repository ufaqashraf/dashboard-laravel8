            ...
            <div class="card-body register-card-body" id="card-register">
                ...
                <form id="register">
                    ...
                    <div class="row">
                        ...
                        <div style="width:48% !important;margin-left:10px;margin-bottom:15px;" class="input-group mb-6">
                        ...
                        <div style="width:48% !important;margin-bottom:15px;margin-right:20px;"
                            class="input-group mb-6">
